...
namespace CpqSystemTool
{
    ...
    internal static class MeteredConnection
    {
        ...
        private static bool Restore(IntPtr admin, IntPtr system, IntPtr backup)
        {
            try
            {
                IntPtr h = OpenKey(KEY_WRITE_DAC);
        ...
        public static void ToggleMetered(Action<string> log)
        {
            ...
            finally { ok = Restore(admin, system, backup); FreeAll(admin, system, backup); }
