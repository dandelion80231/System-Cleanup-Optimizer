...
1. 前往 [Releases](https://github.com/dandelion80231/System-Cleanup-Optimizer/releases/latest) 下载最新版 `.exe`（文件名如 `System-Cleanup-Optimizer_v1.01.exe` 或 `系统清理与优化工具.exe`）。
...
只需分发单个 `系统清理与优化工具.exe` 文件。所有资源（背景图、图标、SKU 许可令牌、源码包）均已嵌入。
