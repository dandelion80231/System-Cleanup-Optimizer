...
namespace CpqShell
{
    internal static class Consts
    {
        ...
        public const string MainExeSha256 = MainExeSha.MainExeSha256; // 值在 MainExeSha.generated.cs（发版构建时置为拟嵌入主 exe 的 SHA；内嵌披露包归一为 64 个 0，见 tools/cpq-shell/README.md）
